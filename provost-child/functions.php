...
function my_theme_enqueue_styles() {
    ...
    wp_enqueue_style( 'parent-theme', get_template_directory_uri() .'/style.css', '', '1.0.1', false);
    wp_enqueue_script( 'child_scripts', get_theme_file_uri().'/assets/js/child-scripts.js', '', '1.0.13', true);
